...
### Problema 1: Pérdida de datos por ausencia de volumen
...
### Problema 2: Pérdida accidental de datos por uso de `down -v`
...
### Problema 3: Montaje en una ruta incorrecta
...
### Problema 4: Permisos incorrectos en bind mounts
...
### Problema 5: Variables de entorno que no se cargan correctamente
...
### Problema 6: Sustitución incorrecta de variables
...
### Problema 7: Confusión entre datos persistentes y configuración local
...
### Problema 8: Inconsistencias entre el entorno local y el contenedor
